...
function handle = turn_on(params)
% Turns on the MPB 642 laser.
%
...
try
    ...
    if strcmp(ME.identifier, 'MATLAB:nonExistentField')
        error(['Missing field in params struct for the MPB 642 laser.']);
...
%% Device control functions
    function deviceControl()
        ...
        g_mmc.setSerialPortCommand(name, 'SETLDENABLE 1', ...
